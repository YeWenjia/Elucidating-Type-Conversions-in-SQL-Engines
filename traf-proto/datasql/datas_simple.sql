create table TA(name varchar(255), height float, age int);
create table TB(realage int, fullname varchar(255), fullheight float);
create table TC(newage int, newheight float, newname varchar(255));

INSERT INTO TA(name, height, age) VALUES ('Lucas Davis', 6.0, 31);
...
INSERT INTO TB(realage, fullname, fullheight) VALUES(27, 'Sarah Brown', 5.6);
INSERT INTO TB(realage, fullname, fullheight) VALUES(29, 'Matthew Lee', 5.2);
INSERT INTO TB(realage, fullname, fullheight) VALUES(32, 'Lucas Parker', 6.0);
...
INSERT INTO TC(newage, newheight, newname) VALUES(-32, 6.0, 'Lucas Parker');
INSERT INTO TC(newage, newheight, newname) VALUES(27, 5.6, 'Sarah Brown');
