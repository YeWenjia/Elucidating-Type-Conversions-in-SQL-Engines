...
class TestOracle(ExperimentMixin, TestEngine):
    experiment_prefix = "oracle"
...
"""
# Connect to FREE PDB
# sqlplus myuser/password@localhost:1521/FREE
# Connect to MYDB PDB
# sqlplus myuser/password@localhost:1521/MYDB
"""
