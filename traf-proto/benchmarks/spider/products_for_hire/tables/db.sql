...
CREATE TABLE bookings (
       ...
       `booking_status_code` VARCHAR(255) NOT NULL,
       `returned_damaged_yn` VARCHAR(255),
       `booking_start_date` TIMESTAMP,
       `booking_end_date` TIMESTAMP,
       `count_hired` VARCHAR(255),
...
CREATE TABLE customers (
       ...
       `good_or_bad_customer` VARCHAR(255),
       `first_name` VARCHAR(255),
       `last_name` VARCHAR(255),
       `gender_mf` VARCHAR(255),
...
CREATE TABLE payments (
       ...
       `booking_id` INTEGER,
       `customer_id` INTEGER NOT NULL,
       `payment_type_code` VARCHAR(255) NOT NULL,
       `amount_paid_in_full_yn` VARCHAR(255),
...
CREATE TABLE products_booked (
       ...
       `returned_yn` VARCHAR(255),
       `returned_late_yn` VARCHAR(255),
